...
<link rel="shortcut icon"
	href="<c:url value="/assets/user/ico/logohutech1_1.ico"/>">
<decorator:head />
</head>
<body>
	<!-- 
				...
				<div class="alignR">
					<div class="pull-left socialNw">
						<a href="#"><span class="icon-twitter"></span></a> <a
							href="https://www.facebook.com/tn.bao.khanh.bk"> <span
					...
					<c:if test="${not empty LoginInfo }">
					 ...
					 <a href="<c:url value="/dang-ky"/>"><span class="icon-edit"></span> Tài khoản  </a> 
					 </c:if>
						...
						<span class="badge badge-warning"><fmt:formatNumber
								type="number" groupingUsed="true" value="${TotalPriceCart }" />VND</span></a>
				</div>
			</div>
		</div>
	</div>
...
-->
	<div class="container">
		...
		<iframe width="100%" height="480"
			src="https://www.youtube.com/embed/9TYVInfHw1A"
	...
	<div class="copyright">
		<div class="container">
			...
			<div class="span">
				<img src="<c:url value="/assets/user/img/logohutech1.png"/>"
					style="max-height: 70px; max-width: 100px"> <span>Copyright
					&copy; 2023 And Edit by 4TV HUTECH </span>
			</div>
		</div>
	</div>
	<a href="#" class="gotop"><i class="icon-double-angle-up"></i></a>
	<!-- Placed at the end of the document so the pages load faster -->
	<script src="<c:url value="/assets/user/js/jquery.js"/>">
		
	</script>
	<script src="<c:url value="/assets/user/js/bootstrap.min.js"/>">
		
	</script>
	<script src="<c:url value="/assets/user/js/jquery.easing-1.3.min.js"/>">
		
	</script>
	<script
		src="<c:url value="/assets/user/js/jquery.scrollTo-1.4.3.1-min.js"/>">
		
	</script>
	<script src="<c:url value="/assets/user/js/shop.js"/>">
