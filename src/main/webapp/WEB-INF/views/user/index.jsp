...
<title>4TV Store-Trang Chủ</title>
				...
				<ul class="nav nav-list">
					...
					<c:forEach var="item" items="${categorys}">
						<li><a href='<c:url value="/san-pham/${item.id }"/>'><span
								class="icon-gittip"> </span>${item.name } </a></li>
					</c:forEach>
					<li style="border: 0">&nbsp;</li>
					<li><a class="totalInCart" href="<c:url value="gio-hang"/>">
							<strong>Đã mua:<span
								class="badge badge-warning pull-right"
								style="line-height: 23px;"><fmt:formatNumber
										type="number" groupingUsed="true" value="${TotalPriceCart }" />VND</span>
						</strong>
					</a></li>
						...
						<div class="caption">
							<h4>
								<a class="defaultBtn" href="product_details.html">VIEW</a> <span
									class="pull-right">23.000.000 VND</span>
							</h4>
						</div>
					</div>
				</li>
				...
				<li>
					<div class="thumbnail">
						...
						<div class="caption">
							<h4>
								<a class="defaultBtn" href="product_details.html">VIEW</a> <span
									class="pull-right">22.000.000 VND</span>
							</h4>
						</div>
					</div>
				</li>
				...
				<li>
					<div class="thumbnail">
						...
						<div class="caption">
							<h4>
								<a class="defaultBtn" href="product_details.html">VIEW</a> <span
									class="pull-right">63.000.000 VND</span>
							</h4>
						</div>
					</div>
				</li>
				...
				<c:if test="${products.size() >0 }">
					<ul class="thumbnails">
						...
						<c:forEach var="item" items="${products }" varStatus="loop">
							...
							<c:if
								test="${(loop.index + 1 )% 3 == 0 || (lopp.index + 1) == products.size()}">
					</ul>
					<c:if test="${(loop.index + 1) <products.size() }">
						<ul class="thumbnails">
					</c:if>
